class ValidationErrors:
    ...
    WARCRAFT_LOGS_ID_RAID_ALREADY_EXISTS = "A raid with this warcraft logs id already exists."
    WARCRAFT_LOGS_ID_LOG_ALREADY_EXISTS = "A log with this warcraft logs id already exists."
